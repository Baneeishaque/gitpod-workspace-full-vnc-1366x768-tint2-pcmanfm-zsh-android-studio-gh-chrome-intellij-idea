...
ARG intellijIdeaDownloadUrl="https://download.jetbrains.com/idea/ideaIU-2021.1.1.tar.gz"
ARG intellijIdeaInstallationFile="ideaIU-2021.1.1.tar.gz"
...
RUN mkdir -p ~/.config/JetBrains/IntelliJIdea2021.1 \
 && cp /usr/local/idea-IU-211.7142.45/bin/idea64.vmoptions ~/.config/JetBrains/IntelliJIdea2021.1/ \
